  ...
  return (
    <main className="home-container">
        <header>
          ...
          <Link className="all-games_link" to='/allgames'>ALL GAMES</Link>
          <div className="dot_navbar"></div>
          <Link className="filter-games_link" to='/games'>FILTERS</Link>

          <Link to='/allgames'>
            <a className="icons-header">
